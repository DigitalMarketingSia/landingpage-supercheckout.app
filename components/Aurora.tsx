...
export default function Aurora(props: AuroraProps) {
    ...
    useEffect(() => {
        ...
        let stopsCache = JSON.stringify(colorStops);
        ...
        const update = (t: number) => {
            ...
            // Only update color stops if they actually changed
            const currentStopsKey = JSON.stringify(currentStops);
            if (currentStopsKey !== stopsCache) {
                stopsCache = currentStopsKey;
                colorStopsArray = currentStops.map(hex => {
                    const c = new Color(hex);
                    return [c.r, c.g, c.b];
                });
